    ...
    <div class="content-wrapper">
        <div class="container">
                            ...
                            <div class="widget-payment-request-container">
                                <div class="widget-payment-request-author">
                                    <div class="avatar m-r-sm">
                                        <img src="{{ asset('backend_assets') }}/images/avatars/avatar2.png" alt="">
                                    </div>
                                ...
                                <div class="widget-payment-request-product">
                                    <div class="widget-payment-request-product-image m-r-sm">
                                        <img src="{{ asset('backend_assets') }}/images/other/facebook_logo.png" class="mt-auto" alt="">
                                    </div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-product-container">
                                <div class="widget-popular-product-image">
                                    <img src="{{ asset('backend_assets') }}/images/widgets/popular-product.jpeg" alt="">
                                </div>
                        ...
                        <div class="row">
                            <div class="col-xl-7">
                                <div class="widget-stats-large-chart-container">
                                    <div class="card-header">
                                        <h5 class="card-title">Basic Information<span class="badge badge-light badge-style-light">Last Year</span></h5>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('profile.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-floating mb-4">
                                                <input type="text" class="form-control" id="userName" placeholder="Name" name="name" value="{{ old('name', $user->name) }}">
                                                <label for="userName">Name</label>
                                            </div>

                                            {{-- email --}}
                                            <div class="form-floating mb-4">
                                                <input type="email" class="form-control" id="userEmail" placeholder="Name" name="email" value="{{ old('email', $user->email) }}">
                                                <label for="userEmail">Email</label>
                                            </div>

                                            <div class="card mb-4 align-items-center">
                                                @if ($user->big_avatar)
                                                    <img class="mt-4" width="100" src="{{ asset($user->big_avatar) }}" alt="current_avatar_big">
                                                @endif
                                                <div class="card-body">
                                                    {{-- big avatar --}}
                                                    <div class="input-group">
                                                        <span class="input-group-text">Your picture</span>
                                                        <input type="file" class="form-control" name="big_avatar" accept="image/*">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group mb-4">
                                                <label for="userProTitle" class="ms-4 form-label">Professional Title</label>
                                                <input type="text" class="form-control" id="userProTitle" placeholder="(e.g. `Professional Web Developer`" name="professional_title" value="{{ old('professional_title', $user->professional_title) }}">
                                            </div>

                                            {{-- bio --}}
                                            <div class="form-group mb-4">
                                                <label for="userBio" class="ms-4 form-label">Bio / Short Description</label>
                                                <textarea rows="2" class="form-control" id="userBio" placeholder="(e.g. web developer with 5 years...)" name="bio">{{ old('bio', $user->bio) }}</textarea>
                                            </div>

                                            {{-- address --}}
                                            <div class="form-floating mb-4">
                                                <input type="text" class="form-control" id="userAddress" placeholder="Address" name="address" value="{{ old('address', $user->address) }}">
                            ...
                            <div class="col-xl-5">
                                <div class="widget-stats-large-info-container">
                                    <div class="card-header">
                                        <h5 class="card-title">At a glance<span class="badge badge-info badge-style-light">Updated 5 min ago</span></h5>
                                    </div>
                                    <div class="card-body">
            ...
            {{-- <div class="row">
                <div class="col-xl-4">
                    <div class="card">
                        <img src="{{ asset('backend_assets') }}/images/widgets/blog5.jpeg" class="card-img-top" alt="...">
                        <div class="card-body">
                    ...
                    <div class="card widget widget-info">
                        <div class="card-body">
                            <div class="widget-info-container">
                                <div class="widget-info-image" style="background: url('{{ asset('backend_assets') }}/images/widgets/security.svg')"></div>
                        ...
                        <div class="card-body">
                            <div class="widget-popular-blog-container">
                                <div class="widget-popular-blog-image">
                                    <img src="{{ asset('backend_assets') }}/images/widgets/product2.jpeg" alt=""> 
                                </div>
                            ...
                            <div class="widget-connection-request-container d-flex">
                                <div class="widget-connection-request-avatar">
                                    <div class="avatar avatar-xl m-r-xs">
                                        <img src="{{ asset('backend_assets') }}/images/avatars/avatar8.jpeg" alt="">
                                    </div>
                                </div>
